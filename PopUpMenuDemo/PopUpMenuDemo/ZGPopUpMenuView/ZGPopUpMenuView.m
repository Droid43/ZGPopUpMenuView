...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.selectedBackgroundView.backgroundColor = self.builder.selectColor;
    cell.backgroundView = [[UIView alloc] initWithFrame:cell.frame];
    cell.backgroundView.backgroundColor = self.builder.normalColor;
    cell.backgroundColor = self.builder.normalColor;
    cell.label.text = self.builder.items[index];
    cell.line.frame = CGRectMake(self.builder.lineEdge + self.builder.arrowHeight,
                                 cell.contentView.frame.size.height - 0.5,
                                 (cell.contentView.frame.size.width - (self.builder.lineEdge + self.builder.arrowHeight) * 2),
                                 0.5);
